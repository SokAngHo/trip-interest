...
window.showRoute = function (routeId) {
  ...
  var currentSelectedRoute = selectRoute(savedRoutes, routeId);
  selectedRouteId = routeId; // Highlight current selected route
...
window.deleteRoute = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(routeId) {
    var res, element;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            if (res.status === 200) {
              element = document.getElementById(routeId);
...
/******/ });
//# sourceMappingURL=Fav.bundle.js.map